...
# Collaborators:
# Professor Toups
# I did the extra credit 6.3 (win/loss record)
...
def enter_action(guessedword):
    ...
    # column = 0
    # makes it so it starts off in the first row
    # for letter in solution:
    # gw.set_square_letter(0, column, letter)
    # column += 1
    # takes each letter in the word and increments it to each box via adding one to columns each time
